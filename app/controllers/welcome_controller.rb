  ...
  def index
    ...
    connect_to_gmail do |gmail|
      Lead.all.each do |lead|
        ...
        # begin
        #   real_email = email.to[0].mailbox + "@" + email.to[0].host 
        #   current_user.emails.create(to: real_email, from: email.from, subject: email.subject, message_body: email.text_part.body.raw_source, date_sent: email.to_imap_date, lead_id: lead.id)
